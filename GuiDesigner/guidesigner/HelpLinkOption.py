...
LinkLabel('link_save_load',**{'text': 'link, save and load', 'font': 'TkFixedFont 12 bold underline', 'link': 'guidesigner/HelpLinkSaveLoad.py', 'fg': 'blue'}).grid(**{'column': '4', 'sticky': 'nes', 'columnspan': '3', 'row': '7'})
