...
Button('ButtonShow',**{'text': 'Show', 'bd': '3', 'bg': 'lightgreen'}).grid(**{'column': '3', 'sticky': 'nesw', 'row': '5'})
...
Button('ButtonGrid',**{'text': 'GRID', 'font': 'TkDefaultFont 9 bold', 'bd': '3', 'bg': 'lightgreen'}).grid(**{'sticky': 'nesw', 'row': '5'})
Button('ButtonHide',**{'text': 'Hide', 'padx': '1m', 'bd': '3', 'bg': 'lightgreen'}).grid(**{'column': '2', 'sticky': 'nesw', 'row': '5'})
Button('Grid()',**{'text': 'Grid()', 'padx': '1m', 'bd': '3', 'bg': 'lightgreen'}).grid(**{'column': '1', 'sticky': 'nesw', 'row': '5'})
...
#Button('ButtonShow',**{'text': 'Show', 'bd': '3', 'bg': 'lightgreen'}).grid(**{'column': '2', 'sticky': 'nesw', 'row': '5'})
