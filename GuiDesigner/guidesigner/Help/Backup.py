...
LinkLabel('link',**{'text': 'Save', 'font': 'TkFixedFont 9 bold underline', 'bg': 'white', 'link': 'guidesigner/Help/SaveLoadContent.py', 'fg': 'blue', 'anchor': 'w'}).grid(**{'column': '3', 'sticky': 'nesw', 'columnspan': '2', 'row': '5'})
