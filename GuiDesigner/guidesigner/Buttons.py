...
LabelFrame("LoadFrame",link="guidesigner/LoadAndRunAll.py") # the frame with the save dialog
LabelFrame("LoadEdit",link="guidesigner/LoadAndEditAll.py") # the frame with the load dialog
