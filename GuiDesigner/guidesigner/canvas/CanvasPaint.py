...
goOut()
grid(**{'rowspan': '2', 'column': '1', 'sticky': 'nesw', 'row': '0'})
Label('x',**{'text': 'x'}).grid(**{'sticky': 's', 'row': '0'})
Label('y',**{'text': 'y'}).grid(**{'sticky': 'n', 'row': '1'})

goOut()
grid(**{'column': '1', 'sticky': 'nesw', 'row': '1'})
Frame('Handling',**{'height': 305, 'width': 420})
goIn()
...
goOut()
place(**{'y': '130', 'x': '285'})
LabelFrame('Drawing',**{'text': 'Drawing', 'pady': '12', 'padx': '15'})
goIn()

Canvas('arc',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
canvas.itemconfig(item,**{'extent':'60.0','start':'20.0','width':'2.0'})


goOut()
grid(**{'column': '1', 'row': '2'})
Canvas('bitmap',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
goOut()
grid(**{'column': '1', 'row': '3'})
Canvas('freehand',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
canvas.itemconfig(item,**{'width':'2.0','tags':'new'})
...
goOut()
grid(**{'column': '2', 'row': '0'})
Canvas('freehand_polygon',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
goOut()
grid(**{'column': '2', 'row': '1'})
Canvas('image',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
canvas.itemconfig(item,**{'photoimage':'guidesigner/images/butterfly.gif','anchor':'nw'})


goOut()
grid(**{'row': '3'})
Canvas('import',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
item = canvas.create_polygon(*coords)
canvas.itemconfig(item,**{'fill':'#2ba9e1','tags':'bird'})
...
item = canvas.create_polygon(*coords)
canvas.itemconfig(item,**{'fill':'#2b3277','tags':'bird'})
...
goOut()
grid(**{'column': '2', 'row': '2'})
Canvas('line',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
goOut()
grid(**{'row': '0'})
Canvas('oval',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
goOut()
grid(**{'row': '2'})
Canvas('polygon',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
goOut()
grid(**{'column': '1', 'row': '1'})
Canvas('polyline',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
goOut()
grid(**{'column': '1', 'row': '0'})
Canvas('rectangle',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
goOut()
grid(**{'row': '1'})
Canvas('text',**{'height': '30', 'width': '30', 'bd': '2', 'relief': 'raised'})
goIn()
...
canvas.itemconfig(item,**{'text':'A','font':'TkDefaultFont 20 bold','anchor':'nw'})
...
goOut()
place(**{'y': '111', 'x': '130'})
LabelFrame('Scaling',**{'text': 'Scaling', 'grid_cols': '(4, 10, 0, 0)', 'grid_rows': '(6, 10, 0, 0)'})
goIn()

Button('OK',**{'text': 'OK'}).grid(**{'column': '1', 'sticky': 'nesw', 'row': '4'})
Checkbutton('both',**{'text': 'both'}).grid(**{'column': '2', 'row': '4'})
Label('lscalex',**{'text': 'scale x'}).grid(**{'column': '1', 'row': '1'})
Label('lscaley',**{'text': 'scale y'}).grid(**{'column': '2', 'row': '1'})
Spinbox('scalex',**{'increment': 0.1, 'width': 6, 'to': 10.0}).grid(**{'column': '1', 'ipady': '3', 'row': '2'})
Spinbox('scaley',**{'increment': 0.1, 'width': 6, 'to': 10.0}).grid(**{'column': '2', 'ipady': '3', 'row': '2'})

goOut()
place(**{'y': '4', 'x': '130'})
LabelFrame('Selected',**{'text': 'Selected', 'height': 108, 'pady': '5', 'width': 140})
goIn()

Label('id',**{'pady': '3', 'padx': '5', 'font': 'TkDefaultFont 9 bold', 'bd': '2', 'bg': 'yellow', 'fg': 'blue', 'relief': 'solid'}).grid(**{'column': '1', 'sticky': 'w', 'pady': '2', 'padx': '2', 'row': '1'})
Label('lid',**{'text': 'id'}).grid(**{'row': '1'})
Label('ltype',**{'text': 'type'}).grid(**{'row': '0'})
Label('type',**{'pady': '3', 'padx': '5', 'font': 'TkDefaultFont 9 bold', 'bd': '2', 'bg': 'yellow', 'fg': 'blue', 'relief': 'solid'}).grid(**{'column': '1', 'sticky': 'w', 'pady': '2', 'padx': '2', 'row': '0'})

goOut()
place(**{'width': '140', 'y': '4', 'x': '280'})
LabelFrame('Settings',**{'text': 'Settings', 'height': 100, 'width': 100})
goIn()

Checkbutton('flat_default',**{'text': 'flat default', 'anchor': 'w'})
Checkbutton('line_default',**{'text': 'line default', 'anchor': 'w'})

widget('line_default').pack(**{'pady': '4', 'anchor': 'w', 'fill': 'x'})
widget('flat_default').pack(**{'pady': '1', 'anchor': 'w', 'fill': 'x'})
...
widget('entry').pack(**{'pady': '1', 'fill': 'both'})

goOut()

Button('overlapped',**{'text': 'overlapping', 'bd': '2'})
Checkbutton('same_tag',**{'text': 'select tag', 'anchor': 'w'})
...
widget('same_tag').pack(**{'pady': '1', 'anchor': 'w', 'fill': 'x'})
...
Button('OK',**{'text': 'OK', 'bd': '2'}).grid(**{'sticky': 'nesw', 'columnspan': '2', 'pady': '2', 'row': '2'})
Spinbox('dx',**{'from': -9999.0, 'width': 5, 'to': 9999.0}).grid(**{'column': '1', 'sticky': 'nesw', 'pady': '2', 'row': '0'})
Spinbox('dy',**{'from': -9999.0, 'width': 5, 'to': 9999.0}).grid(**{'column': '1', 'sticky': 'nesw', 'row': '1'})
Label('ldx',**{'text': 'dx'}).grid(**{'sticky': 'nesw', 'row': '0'})
Label('ldy',**{'text': 'dy'}).grid(**{'sticky': 'nesw', 'row': '1'})

goOut()
grid(**{'column': '2', 'sticky': 'nsw', 'row': '0'})
LabelFrame('Position',**{'text': 'Position', 'grid_cols': '(6, 10, 0, 0)', 'grid_rows': '(4, 10, 0, 0)'})
goIn()

Spinbox('incx1',**{'width': 4, 'to': 1000.0}).grid(**{'column': '3', 'sticky': 'nesw', 'ipady': '2', 'pady': '2', 'padx': '4', 'row': '1'})
Spinbox('incy1',**{'width': 4, 'to': 1000.0}).grid(**{'column': '3', 'sticky': 'nesw', 'ipady': '2', 'pady': '2', 'padx': '4', 'row': '2'})
Label('lincx1',**{'text': 'inc x0'}).grid(**{'column': '4', 'sticky': 'nesw', 'row': '1'})
Label('lincy1',**{'text': 'inc y0'}).grid(**{'column': '4', 'sticky': 'nesw', 'row': '2'})
Label('lx1',**{'text': 'x0'}).grid(**{'column': '1', 'sticky': 'nesw', 'row': '1'})
Label('ly1',**{'text': 'y0'}).grid(**{'column': '1', 'sticky': 'nesw', 'row': '2'})
Spinbox('x1',**{'increment': 10.0, 'from': -9999.0, 'width': 5, 'to': 9999.0}).grid(**{'column': '2', 'sticky': 'nesw', 'ipady': '2', 'pady': '2', 'padx': '4', 'row': '1'})
Spinbox('y1',**{'increment': 10.0, 'from': -9999.0, 'width': 5, 'to': 9999.0}).grid(**{'column': '2', 'sticky': 'nesw', 'ipady': '2', 'pady': '2', 'padx': '4', 'row': '2'})

goOut()
grid(**{'sticky': 'nsw', 'row': '0'})
LabelFrame('Size',**{'text': 'Size', 'grid_cols': '(2, 10, 0, 0)', 'grid_rows': '(4, 10, 0, 0)'})
goIn()

Spinbox('height',**{'from': -9999.0, 'width': 5, 'to': 9999.0}).grid(**{'column': '1', 'sticky': 'nesw', 'ipady': '2', 'pady': '2', 'padx': '4', 'row': '2'})
Label('lheight',**{'text': 'height'}).grid(**{'sticky': 'nesw', 'row': '2'})
Label('lwidth',**{'text': 'width'}).grid(**{'sticky': 'nesw', 'row': '1'})
Spinbox('width',**{'from': -9999.0, 'width': 5, 'to': 9999.0}).grid(**{'column': '1', 'sticky': 'nesw', 'ipady': '2', 'pady': '2', 'padx': '4', 'row': '1'})

goOut()
grid(**{'column': '1', 'sticky': 'nsw', 'row': '0'})

goOut()
grid(**{'column': '1', 'sticky': 'nesw', 'row': '2'})
