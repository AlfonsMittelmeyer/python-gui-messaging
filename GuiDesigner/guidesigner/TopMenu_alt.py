...
Menu('Menu',**{'activebackground': '#7bfeff', 'bg': 'white', 'fg': 'black', 'activeforeground': 'black', 'tearoff': 0, 'relief': 'solid'})
goIn()
...
Menu('Menu',**{'activebackground': '#7bfeff', 'disabledforeground': 'black', 'bg': 'white', 'fg': 'black', 'activeforeground': 'black', 'tearoff': 0, 'relief': 'solid'})
goIn()
...
MenuItem('alphabetical','radiobutton',**{'photoimage': 'guidesigner/images/tools-check-spelling.gif', 'label': 'alphabetical', 'underline': 0, 'compound': 'left', 'value': 'alphabetical'})
MenuItem('i-order','radiobutton',**{'photoimage': 'guidesigner/images/index.gif', 'label': 'pack index', 'underline': 0, 'compound': 'left', 'value': 'index'})
MenuItem('order','command',**{'activebackground': 'white', 'state': 'disabled', 'label': 'Navigation Order'})
MenuItem('separator','separator')
MenuItem('separator','separator')
MenuItem('z-order','radiobutton',**{'photoimage': 'guidesigner/images/sort-ascending.gif', 'label': 'z-order', 'underline': 0, 'compound': 'left', 'value': 'basement'})
